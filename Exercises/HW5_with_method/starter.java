...
class starter {
	...
	public static void main(String args[]) {
		...
		while(true) {
			System.out.print("How much money do want to gamble? (input int or double): ");
			startMoney = sc2.nextInt();
			b = sc2.nextLine();
			if (startMoney > 0) {
				break;
			}
			System.out.println("You cannot gamble negative or zero dollars. Please try again.");
			System.out.println("");
		}
	...
	public static void SlotMachine (Double a) {
		...
		System.out.println("1. Each player starts with their chosen amount to gamble.");
		...
		System.out.println("Thanks for coming! You have $" + money + ". Come again soon!");
	}
