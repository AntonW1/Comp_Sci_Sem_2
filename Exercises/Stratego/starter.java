...
//		boolean victoryPlayer2 = false;
		...
		board.get(x - 1).set(y - 1, new Flag());
		...
		for (int c = 0; c < 6; c++) {
			...
			board.get(x - 1).set(y - 1, new Bomb());
		...
		board.get(x - 1).set(y - 1, new X(10));
		board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
		x = 0;
		y = 0;
		printBoard(board, 1);
		...
		for (int c = 0; c < 5; c++) {
			...
			board.get(x - 1).set(y - 1, new Miner());
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		for (int c = 0; c < 8; c++) {
			...
			board.get(x - 1).set(y - 1, new Scout());
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		board.get(x - 1).set(y - 1, new Piece(9));
		board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
		x = 0;
		y = 0;
		printBoard(board, 1);
		...
		for (int c = 0; c < 2; c++) {
			...
			board.get(x - 1).set(y - 1, new Piece(8));
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		for (int c = 0; c < 3; c++) {
			...
			board.get(x - 1).set(y - 1, new Piece(7));
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		for (int c = 0; c < 4; c++) {
			...
			board.get(x - 1).set(y - 1, new Piece(6));
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		for (int c = 0; c < 4; c++) {
			...
			board.get(x - 1).set(y - 1, new Piece(5));
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
		...
		for (int c = 0; c < 4; c++) {
			...
			board.get(x - 1).set(y - 1, new Piece(4));
			board.get(x - 1).get(y - 1).setVisibleToPlayer1(true);
			x = 0;
			y = 0;
			printBoard(board, 1);
...
/*	public static void playerTurn (int turn, String name) {
	...
	public static void playerTurn (int turn, String name, ArrayList<ArrayList<Piece>> board) {
		...
		while(true) {
			...
			if (validMove(x1, y1, axis, z, board)) {
				break;
			}
			else {
...
*/		
		...
		if (axis.equals("h")) {
			if (((board.get(x1).get(y1).getRank() == 3) && (board.get(x1).get(y1 + z).getRank() == -1)) || ((board.get(x1).get(y1).getRank() == 1) &&  (board.get(x1).get(y1 + z).getRank() == 10)) || ((board.get(x1).get(y1).getRank() > board.get(x1).get(y1 + z).getRank()) && (board.get(x1).get(y1 + z).getRank() != -1))) {
	...
	//			board.get(x1).set(y1 + z, board.get(x1).get(y1));
		...
		if (axis.equals("v")) {
			if (((board.get(x1).get(y1).getRank() == 3) && (board.get(x1 + z).get(y1).getRank() == -1)) || ((board.get(x1).get(y1).getRank() == 1) &&  (board.get(x1 + z).get(y1).getRank() == 10)) || ((board.get(x1).get(y1).getRank() > board.get(x1 + z).get(y1).getRank()) && (board.get(x1 + z).get(y1).getRank() != -1))) {
	...
	public static boolean validMove(int x, int y, String axis, int z, ArrayList<ArrayList<Piece>> board) {
